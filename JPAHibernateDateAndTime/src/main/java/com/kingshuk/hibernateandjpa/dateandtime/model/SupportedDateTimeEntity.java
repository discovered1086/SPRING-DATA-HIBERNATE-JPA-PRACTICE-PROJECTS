...
public class SupportedDateTimeEntity {
	...
	public String toString() {
		...
		return builder.append("======================================================").append("\n")
				...
				//.append("Offset date time converted to zoned date time: ")
				//.append(this.getOffsetDateTime().atZoneSameInstant(this.getZonedDateTime().getZone())).append("\n")
				.append("Offset time: ").append(this.offsetTime).append("\n").append("Zoned date time: ")
				.append(this.zonedDateTime).append("\n").append("Local date time at Kolkata: ")
				.append(this.localDateTime.atZone(this.zonedDateTime.getZone()).toLocalDateTime()).append("\n")
				.append("Offset date time at Kolkata: ")
				.append(this.offsetDateTime.atZoneSameInstant(ZoneId.of("Asia/Kolkata")).toOffsetDateTime())
