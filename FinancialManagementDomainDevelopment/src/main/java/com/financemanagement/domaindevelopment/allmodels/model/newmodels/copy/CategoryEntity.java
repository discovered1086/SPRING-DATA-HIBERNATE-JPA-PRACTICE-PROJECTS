...
public class CategoryEntity implements Serializable {
	...
	@GenericGenerator(name = "categorySequenceGen", strategy = "com.financemanagement.domaindevelopment.allmodels.sequencegenerators.CommonSequenceGenerator", parameters = {
