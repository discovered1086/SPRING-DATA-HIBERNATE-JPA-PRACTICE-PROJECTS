...
@Table(name = "TRANSACTION_LOCATION_V5")
@NoArgsConstructor
@Builder
@Data
...
@DynamicInsert
@DynamicUpdate
public class TransactionLocationV5Entity implements Serializable{
	...
	@MapsId
	private TransactionMasterV5Entity transactionMasterEntity;
